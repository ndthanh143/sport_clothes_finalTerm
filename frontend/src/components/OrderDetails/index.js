                ...
                <div className={cx('payment')}>
                    {paymentInfo.type === 'momo' && (
                        <div className={cx('momo')}>
                            ...
                            <div className={cx('note')}>
                                Sử dụng app MoMo để quét mã trên và thanh toán, đơn hàng sẽ xử lý tự động và cập nhật
                                trong vòng 30p
                            </div>
                        </div>
                    )}
                    ...
                    {paymentInfo.type === 'direct' && (
                        <div className={cx('direct')}>
                            ...
                            <div className={cx('info')}>
                                <p>Bạn vui lòng chuẩn bị số tiền tương ứng và thanh toán cho shipper khi nhận hàng.</p>
                            </div>
                        </div>
                    )}
                </div>
